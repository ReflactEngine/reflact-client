...
public class DamageIndicatorManager {
    ...
    public static void render(MatrixStack matrices, VertexConsumerProvider consumers, Camera camera) {
        ...
        while (iterator.hasNext()) {
            ...
            textRenderer.draw(text, -width / 2f, 0, color, false, matrix, consumers, TextRenderer.TextLayerType.SEE_THROUGH, 0, 0xF000F0);
            textRenderer.draw(text, -width / 2f, 0, color, false, matrix, consumers, TextRenderer.TextLayerType.NORMAL, 0, 0xF000F0);
